                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"> Tabla de Distribuidores</h4>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <button type="submit" class="btn btn-success" onclick="location.href='agregarDistribuidor.php'">Agregar Distribuidor</button>
                                 <!-- Modal -->
